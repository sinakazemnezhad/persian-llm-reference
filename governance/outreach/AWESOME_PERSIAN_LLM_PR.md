...
**Status:** PR open — [MohammadHeydari/Awesome-Persian-LLM#2](https://github.com/MohammadHeydari/Awesome-Persian-LLM/pull/2) (`sinakazemnezhad:add-persian-llm-reference-companion`)
